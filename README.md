...
**Three markets carry the business.** The USA, Canada, and France account for 44% of total revenue across 24 countries. The bottom 15 markets each depend on a single customer. Losing one means that market goes to zero. The recommendation: grow mid-tier markets (Germany, UK, Brazil) to reduce geographic concentration.
